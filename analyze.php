                ...
                <div class="glass-card rounded-3xl p-6 shadow-sm min-h-[400px] flex flex-col items-center justify-center text-center relative overflow-hidden">
                    ...
                    <?php if($result_data): ?>
                        ...
                        <div class="mt-8 flex gap-3 w-full">
                            <button class="flex-1 bg-brand-dark text-white py-3 rounded-xl font-bold text-sm hover:opacity-90 transition">
                                <i class="fa-solid fa-print mr-1"></i> Report
                            </button>
                            <button class="flex-1 bg-white border border-gray-200 py-3 rounded-xl font-bold text-sm hover:bg-gray-50 transition">
                ...
                <div class="bg-pink-300/30 border-l-4 border-brand-pink p-6 rounded-3xl relative overflow-hidden">
                    <div class="relative z-10">
                        ...
                        <p class="text-[11px] leading-relaxed text-gray-700">
                            Results are randomized and not generated by artificial intelligence at this time. Outputs are linked to specific Patient IDs solely for record-keeping and demonstration purposes. Users should ensure that the uploaded cell image corresponds to the selected patient profile. This tool is intended for educational and system-testing use only and must not be relied upon for clinical decision-making, diagnosis, or treatment.
                    </div>
                </div>
            </div>
        </div>
